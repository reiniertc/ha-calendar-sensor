...
from .const import DOMAIN, CONF_CALENDAR_ENTITY, CONF_DAYS_AHEAD, CONF_MAX_EVENTS
...
class AgendaDaySensor(SensorEntity):
    """One sensor per day, with up to N event attributes."""

    _attr_icon = "mdi:calendar"

    def __init__(self, coordinator, day_index: int, max_events: int) -> None:
